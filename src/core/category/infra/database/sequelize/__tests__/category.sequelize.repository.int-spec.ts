...
describe('CategorySequelizeRepository', () => {
  ...
  test('should throw error on update when a entity is not found', async () => {
    const entity = Category.fake().aCategory().build()
  ...
  test('should throw error on delete when a entity is not found', async () => {
  ...
  describe('search method tests', () => {
    it('should only apply paginate when ther other params are null', async () => {
