...
describe("Category Validator", () => {
  ...
  describe("changeName method", () => {
    it("should a invalid category using null name", () => {
      const category = Category.create({ name: "Movie" });
    ...
    it("should a invalid category using empty name", () => {
      const category = Category.create({ name: "Movie" });
    ...
    it("should a invalid category using name as a number", () => {
      const category = Category.create({ name: "Movie" });
    ...
    it("should a invalid category using a name greater than to 255 characters", () => {
      const category = Category.create({ name: "Movie" });
